...
'''
python inference.py --checkpoint_path pretrained_model/reconstruction/reconstruction_model.pth --device 0 --events_file_path data/h5/boxes.h5 --output_folder out
'''
